          ...
          <Card className="mt-6">
            <CardContent className="p-6">
              ...
              <div className="flex flex-wrap gap-4">
                {wordByWord.map((w, i) => (
                  <div key={i} className="rounded-lg bg-primary/5 p-3 text-center">
                    <p className="font-arabic text-lg" dir="rtl">{w.arabic}</p>
                    <p className="mt-1 text-xs text-muted-foreground">{w.english}</p>
                  </div>
                ))}
              </div>
            </CardContent>
        ...
        {dua.benefits && (
          <Card className="mt-6">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground">{dua.benefits}</p>
            </CardContent>
          </Card>
        )}
